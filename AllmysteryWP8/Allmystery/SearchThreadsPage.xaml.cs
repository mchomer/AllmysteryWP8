...
{
    public partial class SearchThreadsPage : PhoneApplicationPage
    {
        ThreadsViewModel threadsviewmodel;
        ProgressBar progressbar;
        private int offset = 0;
        public SearchThreadsPage()
        {
            InitializeComponent();
        ...
        private void ApplicationBarIconButton_Click(object sender, EventArgs e)
        {
            ...
            this.threadsviewmodel.searchThreads(this.tbosearch.Text);
            this.Focus();
        }
        ...
        private void ApplicationBarIconButton_Click_1(object sender, EventArgs e)
        {
            ...
            this.openprogressbar();
            this.threadsviewmodel.gotThreads = this.gotthreads;
            this.threadsviewmodel.searchThreads(this.tbosearch.Text + "&offset=" + this.offset.ToString());
